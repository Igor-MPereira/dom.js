...
import { DOMJSElement } from './dom.d.ts';
...
function DOMJSElement(element, options) {
  ...
  this.toString = function () { return Object.prototype.toString.call(this); }
};

DOMJSElement.prototype[Symbol.toStringTag] = "DOMJSElement";
...
/**
 * 
 * @param {DOMJSElement<HTMLElement>} prototype 
 */
function DOMJSElementPrototype(prototype) {
