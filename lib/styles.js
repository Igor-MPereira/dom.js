...
export function FormatCSSString(string, config) {
  ...
  if(config && config.spacing !== null && config.spacing !== undefined) {
    spacing = config.spacing;
  }

  if (config && config.tabSize !== null && config.tabSize !== undefined) {
