          ...
          case 'object': {
            ...
            for (let styleRuleKey in styles) {
              if (Object.prototype.hasOwnProperty.call(styles, styleRuleKey)) {
                ...
                if(atRuleResultString) {
                  result += atRuleResultString;
                }
                if (appendResult) {
                  result += styleRuleKey + appendResult;
                }
              }
            }
          } break;
...
export function HandleStyleRule(styleRule, upperLevelKey) {
        ...
        if (Object.prototype.hasOwnProperty.call(styleRule, stylePropOrAdditionalRule)) {
          switch(stylePropOrAdditionalRule[0]) {
            ...
            case '@': {
              ...
              if (atRuleResult && atRuleResult.styleRuleString) { atRuleResultString += atRuleKey + '{' + atRuleResult.styleRuleString + (atRuleResult.atRuleResultString || '') + '}'; }
  ...
  return {
    styleRuleString,
    appendResult: appendResultString,
    atRuleResultString
  };
}
/**
