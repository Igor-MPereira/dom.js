...
InternalLogger.prototype.__INTERNAL_LOGGER = function ({
  ...
  switch (type) {
    case 'info':  this.level > 2 && console.info.apply(null, (handleLoggerInput.apply(null, data))); break;
    case 'log':   this.level > 2 && console.log.apply(null, (handleLoggerInput.apply(null, data))); break;
    case 'warn':  this.level > 1 && console.warn.apply(null, (handleLoggerInput.apply(null, data))); break;
    case 'error': this.level > 0 && console.error.apply(null, (handleLoggerInput.apply(null, data))); break;
  }
};
